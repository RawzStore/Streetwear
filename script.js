// Base de données : 4 articles complets avec visuels
const products = [
  { 
    id: 1, 
...
function filterByCategory(category) {
  // 1. Activer le bon bouton dans le catalogue
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Clic sur les boutons de filtre du Catalogue
  document.querySelectorAll('.filter-btn').forEach(btn => {
  ...
  // Clic sur les liens du Menu Latéral (Burger)
  ...
  // Gestion du formulaire Checkout
